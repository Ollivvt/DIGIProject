...
def send_Line(str1,str2,str3):
    ...
    LINE_key = 'm2yxb_g7_8bi7nw9oC6VcL28xVU7FMw3mrOIqqMHSBF'
...
def send_Sheets(str1,str2,str3):
    SHEETS_event_name = 'digi_google'
    SHEETS_key = 'm2yxb_g7_8bi7nw9oC6VcL28xVU7FMw3mrOIqqMHSBF'
    # Your IFTTT LINE_URL with event name, key and json parameters (values)
...
def main():
    ...
    while (key_detect==0) :
        ...
        for num in range(len(results)) :
            ...
            if ((labels[label_id] == 'bottle') and (label_score >= 0.6)
                and (box_top > int(0.5 * CAMERA_HEIGHT))
                and (box_left < int(0.5 * CAMERA_WIDTH))):
