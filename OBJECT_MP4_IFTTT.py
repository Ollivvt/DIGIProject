...
def send_Line(str1,str2,str3):
    LINE_event_name = 'LLLLLLLLLLLLLLLLLLLLLLLLLLLL'
    LINE_key = 'KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK'
...
def send_Sheets(str1,str2,str3):
    SHEETS_event_name = 'SSSSSSSSSSSSSSSSSSSSSSSSSSSSSS'
    SHEETS_key = 'KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK'
    # Your IFTTT LINE_URL with event name, key and json parameters (values)
