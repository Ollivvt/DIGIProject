...
def send_Line(str1,str2,str3):
    LINE_event_name = 'LLLLLLLLLLLLLLLLLLLLLLLLLLL'
    LINE_key = 'KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK'
...
def send_Sheets(str1,str2,str3):
    SHEETS_event_name = 'SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
    SHEETS_key = 'KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK'
    # Your IFTTT LINE_URL with event name, key and json parameters (values)
